...
// Basit IBAN kontrolü (TR ile başlar, 26 chars)
    ...
    useEffect(() => {
        ...
        async function fetchRoles() {
            try {
                ...
                // default: Customer
                const customer = list.find((r) => (r.code || "").toLowerCase() === "customer") || list[0];
                ...
                setSubmitError("Roles could not be loaded. Please refresh the page.");
            } finally {
                if (alive) {
        ...
        <div className="w-full flex flex-col bg-white">
            <section className="w-full">
                <div className="w-full max-w-2xl mx-auto px-4 py-12 flex flex-col gap-8">
                    ...
                    {submitError && (
                        <div className="w-full border border-[#E6E6E6] bg-[#FAFAFA] px-4 py-3 text-[14px] text-[#E74040]">
                            {submitError}
                        </div>
                    )}
                    ...
                    >
                        ...
                        {isStoreRole && (
                            <div className="w-full flex flex-col gap-5 border border-[#E6E6E6] p-4">
                                <div className="font-bold text-[16px] text-[#252B42]">
                                    Store Details
                                </div>
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <input
                                        ...
                                        {...register("store_tax_no", {
                                            ...
                                            validate: (v) =>
                                                TAX_NO_REGEX.test(v) ||
                                                "Format must be TXXXXVXXXXXX (X=number)",
                                        })}
                                    />
                                    {errors.store_tax_no && (
                                        <div className="text-[12px] text-[#E74040]">
                        ...
                        <button
                            ...
                            className={`w-full h-12 rounded-[5px] font-bold text-[14px] leading-[22px] tracking-[0.2px] text-white flex items-center justify-center gap-2 ${isSubmitting ? "bg-[#BDBDBD]" : "bg-[#23A6F0]"
                                }`}
                        >
                            {isSubmitting && (
